...
<div class="row">
    ...
    <div class="col-md-2 h2">
        <a href="cadastrar.php" class="btn btn-primary">Novo Cargo</a>
    </div>
</div>
</header>
<div class="container">
    ...
    <div class="col-md-8">
        <table class="table table-striped">
            ...
            <tbody>
                ...
                <tr>
                    <th><?php echo $cargos->Codigo;?></th>
                    <th><?php echo $cargos->Nome;?></th>
                    <th><?php echo $cargos->Tipo;?></th>
                    <td>
                    	<a href="alterar.php?codigo=<?php echo $cargos->Codigo; ?>" class="btn btn-success">Alterar</a>
                    	<a href="index.php?codigo=<?php echo $cargos->Codigo; ?>" class="btn btn-danger">Excluir</a>
                    </td>
                </tr>
            <?php endforeach; ?>
            <?php else : ?>
