...
<div class="row">
    ...
    <div class="col-md-2 h2">
        <a href="cadastrar.php" class="btn btn-primary">Nova Urna</a>
    </div>
</div>
</header>
<div class="container">
    ...
    <div class="col-md-8">
        <table class="table table-striped">
            ...
            <tbody>
                ...
                <tr>
                    <th><?php echo $urna->Numero;?></th>
                    <th><?php echo $urna->Municipio ?></th>
                    <th><?php echo $urna->Zona ?></th>
                    <th><?php echo $urna->Secao ?></th>
                    
                    <td>
                    	<a href="alterar.php?numero=<?php echo $urna->Numero; ?>" class="btn btn-success">Alterar</a>
                    	<a href="index.php?numero=<?php echo $urna->Numero; ?>" class="btn btn-danger">Excluir</a>
                    </td>
                </tr>
            <?php endforeach; ?>
            <?php else : ?>
